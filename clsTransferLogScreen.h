...
private:
    ...
    static void PrintTransferLogRecordLine(clsBankClient::stTransferLogRecord TransferLogRecord)
    {
        ...
        cout << "| " << setw(10) << left << TransferLogRecord.DestinitionAccountBalanceAfter;
...
public:
    ...
    static void ShowTransferLogScreen()
    {
        ...
        vector <clsBankClient::stTransferLogRecord> vTransferLogRecord = clsBankClient::LoadTransferLogDataFromFile();
