...
public:
    ...
    float CalculateCurrencyFromUSD(float Amount)
    {
        return Amount / _Rate;
    }

    float CalculateToOtherCurrency(clsCurrency CurrencyTo, float Amount)
    {
        float AmountInUsd = CalculateCurrencyToUSD(Amount);
